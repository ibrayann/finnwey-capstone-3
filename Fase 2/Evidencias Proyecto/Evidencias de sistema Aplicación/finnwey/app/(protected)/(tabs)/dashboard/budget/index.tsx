...
export default function BudgetScreen() {
  ...
  const CategoryBudgetCard = ({ category, existingBudget, onPress }: { category: SupabaseCategory; existingBudget?: SupabaseBudget; onPress: () => void }) => {
    ...
    return (
      <TouchableOpacity onPress={onPress} className="bg-white dark:bg-gray-800 rounded-3xl w-full border border-gray-200 dark:border-gray-700 shadow-sm" style={{ height: 240, padding: 20, marginBottom: 12 }}>
        <View className="flex-1 justify-between">
          ...
          <View className="items-start flex-1 justify-center">
            ...
            {existingBudget ? (
              <>
                <Text className="text-gray-500 dark:text-gray-300 text-sm mb-3">{daysRemaining} Días Restantes</Text>
                {/* Tipo de presupuesto */}
              ...
              <Text className="text-gray-500 dark:text-gray-300 text-sm mb-4">Sin configurar</Text>
            )}
          </View>

          {/* Monto */}
          <View className="items-start relative w-full mt-2">
            {existingBudget ? (
              <>
    ...
    <View className="flex-1 bg-[#166534] dark:bg-gray-900">
      <SafeAreaView edges={['top']} className="flex-1">
        <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
          ...
          <View className="bg-white dark:bg-gray-800 mt-4 rounded-t-3xl px-6 pt-6 pb-8">
            ...
            {/* Grid de categorías */}
            <View className="flex-row flex-wrap pb-24" style={{ gap: 12 }}>
              ...
              {categories
                ...
                .map((category) => {
                  ...
                  return (
                    <View key={category.id} style={{ width: '47%' }}>
